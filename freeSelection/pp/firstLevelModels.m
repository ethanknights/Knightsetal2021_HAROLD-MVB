...
parfor s = 1:nSubs
  ...
  for i = 1:2 %i=1 is firstLevelModel, i=2 is firstLevelModel_smooth
    ...
    if i == 1 %not smoothed - data/firstLevelModel
      matlabbatch{1}.spm.stats.fmri_spec.sess.scans = cellstr(spm_select('ExtFPList',source_subDir,'^mswar.*\.nii$'));
    elseif  i == 2 %smoothed - data/firstLevelModel_smoothed
      matlabbatch{1}.spm.stats.fmri_spec.sess.scans = cellstr(spm_select('ExtFPList',source_subDir,'^smswar.*\.nii$'));
    end
    ...
    for con = 1:size(trialInfo.onsetLabels,2)
      ...
      matlabbatch{1}.spm.stats.fmri_spec.sess.cond(con).onset = [trialInfo.onset{con,s}];
      matlabbatch{1}.spm.stats.fmri_spec.sess.cond(con).duration = 0; %[trialInfo.durations(con)]; %0s as in aa_firstLevelmodel
    ...
    matlabbatch{1}.spm.stats.con.consess{1}.tcon.weights = [1 1 1 1]; %Index Middle Ring Little
    matlabbatch{1}.spm.stats.con.consess{1}.tcon.sessrep = 'none';

    
    %Not interested in these, but maybe useful later
    matlabbatch{1}.spm.stats.con.consess{2}.tcon.name = 'Index > Baseline';
    matlabbatch{1}.spm.stats.con.consess{2}.tcon.weights = [1 0 0 0];
    matlabbatch{1}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
    
    matlabbatch{1}.spm.stats.con.consess{3}.tcon.name = 'Middle > Baseline';
    matlabbatch{1}.spm.stats.con.consess{3}.tcon.weights = [0 1 0 0];
    matlabbatch{1}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
    
    matlabbatch{1}.spm.stats.con.consess{4}.tcon.name = 'Ring > Baseline';
    matlabbatch{1}.spm.stats.con.consess{4}.tcon.weights = [0 0 1 0];
    matlabbatch{1}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
    
    matlabbatch{1}.spm.stats.con.consess{5}.tcon.name = 'Little > Baseline';
